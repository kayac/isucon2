...
XS_EUPXS(XS_Devel__Peek_SvREFCNT_inc); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Devel__Peek_SvREFCNT_inc)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sv");
...
XS_EUPXS(XS_Devel__Peek_SvREFCNT_dec); /* prototype to pass -Wmissing-prototypes */
XS_EUPXS(XS_Devel__Peek_SvREFCNT_dec)
{
    dVAR; dXSARGS;
    if (items != 1)
       croak_xs_usage(cv,  "sv");
