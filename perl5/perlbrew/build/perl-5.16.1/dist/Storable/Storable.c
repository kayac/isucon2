...
XS_EUPXS(XS_Storable__Cxt_DESTROY)
{
	...
	SV *	self = ST(0)
;
#line 6287 "Storable.xs"
	stcxt_t *cxt = (stcxt_t *)SvPVX(SvRV(self));
#line 6448 "Storable.c"
#line 6289 "Storable.xs"
	if (kbuf)
		Safefree(kbuf);
...
XS_EUPXS(XS_Storable_init_perinterp)
{
    ...
    if (items != 0)
       croak_xs_usage(cv,  "");
    {
#line 6322 "Storable.xs"
  init_perinterp(aTHX);
#line 6472 "Storable.c"
    }
    XSRETURN_EMPTY;
}
...
;
	SV *	RETVAL;
#line 6372 "Storable.xs"
  RETVAL = pretrieve(aTHX_ f);
#line 6540 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 6388 "Storable.xs"
  RETVAL = dclone(aTHX_ sv);
#line 6580 "Storable.c"
	ST(0) = RETVAL;
	sv_2mortal(ST(0));
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    SP -= items;
    {
#line 6398 "Storable.xs"
  bool result;
#line 6600 "Storable.c"
#line 6400 "Storable.xs"
  if (ix) {
   dSTCXT;
