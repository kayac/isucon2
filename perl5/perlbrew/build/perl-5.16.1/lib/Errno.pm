...
"x86_64-linux-2.6.18-308.16.1.el5xen" or
	die "Errno architecture (x86_64-linux-2.6.18-308.16.1.el5xen) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
